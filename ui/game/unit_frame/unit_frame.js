...
App.StonehearthCommandButtonView = App.View.extend({
   ...
   didInsertElement: function () {
      ...
      if (argValue == 'damage' || argValue == 'utility') {
         ...
         description = tower_defense.getTowerWeaponTooltipContent(towerWeapons[argValue].uri, catalogData.tower.weapons.default_weapon) + `<div class='towerCost'>${cost}</div>`;
      }
