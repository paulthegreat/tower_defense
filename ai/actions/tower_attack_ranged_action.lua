...
AttackRanged.name = 'tower attack ranged'
AttackRanged.does = 'tower_defense:tower_attack_ranged'
AttackRanged.args = {
   target = Entity
}
...
function AttackRanged:_create_projectile(attacker, target, projectile_speed, projectile_uri)
